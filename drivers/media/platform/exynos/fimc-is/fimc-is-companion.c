...
retry:
	...
	/* HACK: for GED */
	strncpy(sysfs_finfo->load_c1_fw_name, COMP_FW_EVT1, 21);
...
int fimc_is_comp_loadsetf(struct fimc_is_core *core)
{
	...
	/* HACK: for GED */
	strncpy(sysfs_finfo->load_c1_mastersetf_name, COMP_SETFILE_MASTER, 28);
	strncpy(sysfs_finfo->load_c1_modesetf_name, COMP_SETFILE_MODE, 26);
